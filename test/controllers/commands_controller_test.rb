...
class CommandsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create command" do
    assert_difference("Command.count") do
      post commands_url, params: { command: { is_available: @command.is_available, name: @command.name, requires_admin: @command.requires_admin } }
    end
  ...
  test "should update command" do
    patch command_url(@command), params: { command: { is_available: @command.is_available, name: @command.name, requires_admin: @command.requires_admin } }
